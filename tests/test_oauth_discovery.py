...
def _make_app_with_discovery(
    ...
    from mcp.server.fastmcp.server import FastMCP  # noqa: PLC0415
...
class TestProtectedResourceMetadata:
    ...
    def test_resource_documentation_included_when_provided(self) -> None:
        client = _make_app_with_discovery(resource_documentation="https://mcp.example.com/docs")
        resp = client.get("/.well-known/oauth-protected-resource")
    ...
    def test_resource_documentation_omitted_by_default(self) -> None:
        ...
        assert (
            ...
            not in client.get("/.well-known/oauth-protected-resource").json()
        )
